...
export interface HeaderContactConfig {
  phone: string;
  phoneHref: string;
  email: string;
  emailHref: string;
...
export interface SiteConfig {
  ...
  brandName: string;
  logoUrl?: string;
  headerContact?: HeaderContactConfig;
  socials?: SocialLinks;
}
...
export const extraConfig: ExtraConfig = {
  ...
  whatsappUrl: "https://wa.me/556283143967?text=Ol%C3%A1!%20Gostaria%20de%20agendar%20uma%20consulta%20jur%C3%ADdica.",
};
